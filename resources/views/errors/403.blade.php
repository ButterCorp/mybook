...
<head>
    <meta charset="UTF-8">
    <title>403 Forbidden - MyBook</title>
    <!-- Favicon -->
    <link rel="shortcut icon" href="<?php echo e(asset('/image/template/MyBookOne/favicon.png')); ?>" />
    ...
    <style>
        ...
        .error-message {
            ...
            text-shadow: .5vmin .5vmin 0 #000000, -.5vmin .5vmin 0 #000000, .5vmin -.5vmin 0 #000000, -.5vmin -.5vmin 0 #000000, .5vmin 0 0 #000000, -.5vmin 0 0 #000000, 0 -.5vmin 0 #000000, 0 .5vmin 0 #000000;
            color: #ffffff;
        }
...
<script>
    ...
    TweenMax.to(rcrp, .25, {
        ...
        yoyo: true,
        attr: {
            transform: 'rotate(-20, 86.3, 21.38)'
        }
    });
