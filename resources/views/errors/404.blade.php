...
<head>
    <meta charset="UTF-8">
    <title>404 Not found - MyBook</title>
    ...
    <style>
        ...
        .container > .image-404 .cls-1 {
            fill: #3ba6cc;
        }
        .container > .image-404 .cls-2 {
            fill: #3eb8eb;
        }
        .container > .image-404 .cls-3 {
            fill: #c3d4d8;
        }
        .container > .image-404 .cls-4 {
            fill: #e1ebef;
        }
        .container > .image-404 .cls-5 {
            fill: #37b7ea;
        }
        .container > .image-404 .cls-6 {
            fill: #a2b7bc;
        }
        .container > .image-404 .cls-7 {
            fill: #a9a9a9;
        }
        .container > .image-404 .cls-8 {
            fill: #9c9b9b;
        }
        .container > .image-404 .cls-9 {
            fill: #f197be;
        }
        .container > .image-404 .cls-10 {
            fill: #565656;
        }
        .container > .image-404 .cls-11 {
            fill: #fff;
        }
        .container > .image-404 .cls-12 {
            fill: #e9eff2;
        }
        .container > .not-found {
            margin-top: 62px;
...
<link rel="stylesheet" href="http://static.parastorage.com/services/santa-resources/resources/viewer/user-site-fonts/v3/helvetica.css" type="text/css" />
<div class="container">
    ...
    <div class="description">We looked everywhere for this page.<br>
